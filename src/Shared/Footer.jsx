...
const Footer = () => {
  ...
  <div className="mx-auto max-w-screen-xl px-4 pb-8 pt-16 sm:px-6 lg:px-8 lg:pt-24">
    <div className="text-center">
      <h2 className="text-3xl font-extrabold text-gray-900 sm:text-5xl">Customize Your Tasks</h2>

      <p className="mx-auto mt-4 max-w-sm text-gray-500">
      With Task Master Services, you&apos;ll be able to customize the tasks you have to create wonderful experiences. 
      </p>
